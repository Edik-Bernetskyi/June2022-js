...
let simpsons = [
    ...
    },
    {
        ...
        info: 'Ма́рджори Жакли́н «Мардж» Си́мпсон (в девичестве Бувье́) (англ. Marjorie Jacqueline «Marge» Simpson) — ' +
            ...
            'Мардж — единственный член семьи, посещающий церковь добровольно. Старается поддерживать нравственность не ' +
    ...
    },
    {
        ...
        info: 'Ма́ргарет Эвелин «Мэ́гги» Си́мпсон (англ. Margaret Evelyn “Maggie” Simpson) — персонаж мультсериала ' +
            '«Симпсоны». Впервые появилась на телевидении в шоу Трейси Ульман, в короткометражке ' +
            'Good Night (англ.)русск. 19 апреля 1987 года. Мэгги была придумана и разработана карикатуристом' +
            ' Мэттом Грейнингом, пока он ждал встречи с Джеймсом Л. Бруксом. Названа в честь младшей сестры Грейнинга. ' +
...
for (const simpson of simpsons) {
    ...
    mainDiv.append(h2, paragraph, image);
}
...
div8.classList.add('wrap', 'collapse', 'alpha','beta')
document.body.append(div8);
const node = div8.cloneNode(true);
...
for (const item of coursesAndDurationArray) {
    ...
    const innerDiv = document.createElement('div2');
...
for (const item of coursesAndDurationArray2) {
    ...
    const innerDiv = document.createElement('div3');
...
document.body.append(div,button2);
...
const button6 = document.createElement('button6');
button6.innerText = 'Click'

document.body.append(input, button6);
